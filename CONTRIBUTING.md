Contributing to Kalkulus Client
============================

The Kalkulus Client project operates an open contributor model where anyone is
...
The following applies to code changes to the Kalkulus Client project, and is not to be
confused with overall klks Network Protocol consensus changes.

Whether a pull request is merged into Kalkulus Client rests with the project merge
...
Patches that change klks consensus rules are considerably more involved than
...
Where a patch set proposes to change the klks consensus, it must have been
...
The project leader is the release manager for each Kalkulus Client release.

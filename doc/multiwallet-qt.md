...
In order to support loading of multiple wallets in klks-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is klks.cpp.
...
Changes to klks.cpp
----------------------
klks.cpp is the entry point into klks-qt, and as such, will require some minor modifications to provide hooks for

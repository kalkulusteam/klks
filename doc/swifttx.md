...
This mechanism has been integrated into Bitcore-Node-klks which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/klks-Project/insight-api-klks#web-socket-api](https://github.com/klks-Project/insight-api-klks#web-socket-api) 
* API: [https://github.com/klks-Project/insight-api-klks#swifttx-transactions](https://github.com/klks-Project/insight-api-klks#swifttx-transactions) 
...
By default, the Kalkulus Client daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Kalkulus Client daemon:

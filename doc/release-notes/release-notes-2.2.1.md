Kalkulus Client version 2.2.1 is now available from:

  <https://github.com/klks-project/klks/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/klks-project/klks/issues>

Compatibility
==============

Kalkulus Client is extensively tested on multiple operating systems using
...
Kalkulus Client should also work on most other Unix-like systems but is not
...
of Bitcoin that klks was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/klks-project-translations/).

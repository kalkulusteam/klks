/* src/config/klks-config.h.  Generated from klks-config.h.in by configure.  */
/* src/config/klks-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.klkscoin.info"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Kalkulus Client"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Kalkulus Client 2.4.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "klks"

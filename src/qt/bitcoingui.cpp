                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Kalkulus Client") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a klks address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and klks: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Kalkulus Client"), this);
    aboutAction->setStatusTip(tr("Show information about Kalkulus Client"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for klks"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your klks addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified klks addresses"));
    ...
    openAction->setStatusTip(tr("Open a klks: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Kalkulus Client help message to get a list with possible klks command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Kalkulus Client client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to klks network", "", count));
}
...
{
    QString strTitle = tr("Kalkulus Client"); // default title

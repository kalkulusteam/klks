...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* klks features */
        {"klks", "masternode", &masternode, true, true, false},
        {"klks", "masternodelist", &masternodelist, true, true, false},
        {"klks", "mnbudget", &mnbudget, true, true, false},
        {"klks", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"klks", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"klks", "mnsync", &mnsync, true, true, false},
        {"klks", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"klks", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use klksd, or the -server option to klks-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> klks-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51122/\n";
}

...
RESOURCES += src/qt/klks.qrc src/qt/klks_locale.qrc

TRANSLATIONS += src/qt/locale/klks_bg.ts \
                src/qt/locale/klks_de.ts \
                src/qt/locale/klks_en.ts \
                src/qt/locale/klks_es.ts \
                src/qt/locale/klks_fi.ts \
                src/qt/locale/klks_fr.ts \
                src/qt/locale/klks_it.ts \
                src/qt/locale/klks_ja.ts \
                src/qt/locale/klks_pl.ts \
                src/qt/locale/klks_pt.ts \
                src/qt/locale/klks_ru.ts \
                src/qt/locale/klks_sk.ts \
                src/qt/locale/klks_sv.ts \
                src/qt/locale/klks_vi.ts \
                src/qt/locale/klks_zh_CN.ts \
                src/qt/locale/klks_zh_TW.ts
